...
with open(file='D:\\INNOMATICS INTERN\\rag_llms\\rag_app\\key.text', mode='r') as f:
    api_key = f.read()
...
st.write("This app uses the RAG (Retrieve, Answer, Generate) system to answer questions based on the 'Leave No Context Behind' paper.")
